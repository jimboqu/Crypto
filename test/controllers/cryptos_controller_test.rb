...
class CryptosControllerTest < ActionController::TestCase
  ...
  test "should create crypto" do
    assert_difference('Crypto.count') do
      post :create, crypto: { amount_owned: @crypto.amount_owned, cost_per: @crypto.cost_per, index: @crypto.index, symbol: @crypto.symbol, user_id: @crypto.user_id }
    end
  ...
  test "should update crypto" do
    patch :update, id: @crypto, crypto: { amount_owned: @crypto.amount_owned, cost_per: @crypto.cost_per, index: @crypto.index, symbol: @crypto.symbol, user_id: @crypto.user_id }
    assert_redirected_to crypto_path(assigns(:crypto))
  end
